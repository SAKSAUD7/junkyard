...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # We assume 'backend/data' is where the files are located
        # The file is at backend/apps/common/management/commands/import_data.py
        # root of backend is ../../../.. (4 levels up)

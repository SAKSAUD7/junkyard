...
# DISABLED: This signal was sending emails to ALL active vendors (causing 285+ emails per lead)
# User requested to remove vendor email notifications completely
# Only admin should receive lead notifications (handled in apps/leads/signals.py)

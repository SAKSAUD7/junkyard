            ...
            <div className="relative min-h-[60vh] flex items-center overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16">
                    <div className="text-center space-y-8 animate-fade-in">
                        ...
                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-cyan-300 to-purple-300 leading-tight">
                            Browse by
                        ...
                        <div className="max-w-2xl mx-auto">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-14 pr-4 py-5 bg-white/10 border-2 border-white/20 rounded-2xl text-white text-lg placeholder-white/50 focus:border-cyan-400 focus:bg-white/20 outline-none transition-all backdrop-blur-sm"
                                />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            {filteredStates.map((state) => (
                                ...
                                >
                                    ...
                                    {/* Card */}
                                    <div className="relative bg-dark-800/50 backdrop-blur-sm border border-white/10 rounded-2xl p-6 transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:border-cyan-400/50">
                                        {/* State Icon */}

    ...
    return (
        <div className="min-h-full pb-20 md:pb-8 w-full bg-[#f8fafc]">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="bg-white rounded-2xl md:rounded-3xl shadow-[0_4px_20px_rgb(0,0,0,0.03)] p-2 mb-4 md:mb-6 flex flex-col md:flex-row gap-2 border border-slate-100 mx-1">
                    <div className="flex-1 relative">
                        <svg className="w-5 h-5 absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {loading ? (
                        ...
                        leads.map((lead) => (
                            ...
                            >
                                ...
                                <div className="ml-0 md:ml-[3.75rem] border-t border-slate-100 pt-3 mt-3">
                                    <div className="flex flex-wrap gap-y-2 gap-x-4 md:gap-x-6 text-xs md:text-sm text-slate-500 font-medium">

    ...
    return (
        <div>
            ...
            <div className="vendor-mobile-cards vendor-mobile-only">
                {inventory.length > 0 ? (
                    inventory.map((item) => (
                        <div key={item.id} className="vendor-mobile-card">
                            ...
                            <div className="vendor-mobile-card-body">
                                <div className="vendor-mobile-card-row">
                                    <span className="vendor-mobile-card-label">Make:</span>
                                    <span className="vendor-mobile-card-value">{item.make || '-'}</span>
                                </div>

                                {item.model && (
                                    <div className="vendor-mobile-card-row">
                                        <span className="vendor-mobile-card-label">Model:</span>
                                        <span className="vendor-mobile-card-value">{item.model}</span>
                                    </div>
                                )}
                                ...
                                {item.part_name && (
                                    <div className="vendor-mobile-card-row">
                                        ...
                                        <span className="vendor-mobile-card-value">{item.part_name}</span>
                                    </div>
                                )}

                                {item.year_start && item.year_end && (
                                    <div className="vendor-mobile-card-row">
                                        <span className="vendor-mobile-card-label">Years:</span>
                                        <span className="vendor-mobile-card-value">{item.year_start} - {item.year_end}</span>
                                    </div>
                                )}
                            </div>

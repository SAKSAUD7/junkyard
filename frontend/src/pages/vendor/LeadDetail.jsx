        ...
        <div className="min-h-screen bg-gray-50 pb-20 md:pb-8">
            ...
            <div className="relative bg-gradient-to-br from-blue-600 to-teal-600 pt-6 pb-8 px-6 rounded-b-[2rem] shadow-lg mb-6 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto text-white">
                    <Link to="/vendor/leads" className="inline-flex items-center gap-2 text-blue-100 hover:text-white transition-colors mb-4 text-sm font-semibold backdrop-blur-sm bg-white/10 px-3 py-1.5 rounded-lg">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                        ...
                        <span className={`px-4 py-2 rounded-xl text-sm font-bold shadow-lg shadow-black/10 backdrop-blur-md border border-white/20 capitalize ${lead.status === 'new' ? 'bg-blue-500/90 text-white' :
                            lead.status === 'contacted' ? 'bg-amber-500/90 text-white' :
                                lead.status === 'converted' ? 'bg-green-500/90 text-white' :
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Quick Actions Card */}
                        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl shadow-lg shadow-gray-900/10 p-6 text-white">
                            ...
                            <div className="space-y-3">
                                <a
                                    ...
                                    className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white/10 hover:bg-white/20 border border-white/10 backdrop-blur-sm transition-all text-sm font-bold"
                                >
                                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                    </svg>

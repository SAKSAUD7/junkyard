...
export default function Terms() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-teal-50 text-gray-700 selection:bg-purple-100">
            {/* SEO Meta Tags */}
            <SEO
            ...
            <div className="relative compact-section overflow-hidden bg-gradient-to-br from-blue-600 to-teal-600">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    <div className="bg-white shadow-xl border border-gray-100 rounded-2xl md:rounded-3xl compact-card space-y-3 sm:space-y-4 md:space-y-6 text-gray-600 leading-relaxed -mt-8 relative z-20">
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">DEFINITIONS</h2>

                            <h3 className="compact-heading font-bold text-gray-800 mb-1.5 sm:mb-2 md:mb-3 mt-3 sm:mt-4 md:mt-6">Parties</h3>
                            ...
                            <h3 className="compact-heading font-bold text-gray-800 mb-1.5 sm:mb-2 md:mb-3 mt-3 sm:mt-4 md:mt-6">Content</h3>
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">1. Terms</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">2. Disclaimer</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">3. Limitations</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">4. Revisions and Errors</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">5. Links</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">6. Site Terms of Use Modifications</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">7. Governing Law</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">8. English Language</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">9. Copyright policy, notice and claim information</h2>
                            <p className="compact-text">
                        ...
                        <section>
                            <h2 className="compact-title font-bold text-gray-900 mb-2 sm:mb-3 md:mb-4">10. Comment Disclaimer</h2>
                            <p className="mb-2 sm:mb-3 md:mb-4 compact-text">

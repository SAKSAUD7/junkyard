        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
                    ...
                    <p className="text-white/60 mb-8">The vendor you're looking for doesn't exist.</p>
                    <button
            ...
            <div className="bg-white/5 backdrop-blur-sm border-b border-white/10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center gap-2 text-sm text-white/60">
                        ...
                        <Link to="/vendors" className="hover:text-cyan-400 transition-colors">Vendors</Link>
                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                        </svg>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                ...
                                <div className="bg-gradient-to-br from-blue-500/10 to-purple-500/10 backdrop-blur-xl border border-blue-500/20 rounded-2xl md:rounded-3xl compact-card">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="text-lg font-bold text-white mb-2">Customer Review</h3>
                                            <p className="text-white/80 italic">"{vendor.reviewSnippet}"</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="lg:col-span-1">
                            <div className="sticky top-24">
                                ...
                                <button
                                    onClick={() => navigate('/vendors')}
                                    className="w-full mt-6 bg-white/5 hover:bg-white/10 backdrop-blur-sm border border-white/10 text-white font-semibold py-3 px-6 rounded-2xl transition-all duration-300 flex items-center justify-center gap-2"
                                >

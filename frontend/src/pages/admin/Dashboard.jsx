        ...
        <div className="max-w-[1600px] mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-base font-bold text-slate-900">Trusted Vendors</h2>
                    ...
                    {trustedVendors.length > 0 ? (
                                ...
                                <div key={v.id} className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {v.is_featured && <span className="bg-amber-100 text-amber-700 text-[9px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider">Featured</span>}
                                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center h-40 gap-2 text-slate-300">
                            ...
                            <p className="text-xs text-slate-400">No trusted vendors found</p>
                        </div>
                    )}
                </div>

                ...
                <div className="min-h-screen bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900 pt-32 pb-20">
                    <div className="max-w-3xl mx-auto px-4">
                        <div className="relative">
                            ...
                            <div className="relative bg-dark-800/60 backdrop-blur-2xl border border-green-500/20 rounded-3xl p-12 text-center">
                                ...
                                <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto leading-relaxed">
                                    Thank you for choosing the <span className="text-cyan-400 font-bold">{subscriptionPlans.find(p => p.id === formData.subscription_plan)?.name}</span>! We'll review your application and get back to you within <span className="text-green-400 font-bold">1-2 business days</span>.
                                </p>

                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <button
                                        onClick={() => navigate('/')}
                                        className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold rounded-xl overflow-hidden transition-all duration-300 hover:scale-105"
                                    >
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                {step === 1 && (
                                    <div className="space-y-6 animate-fade-in">
                                        <div className="mb-8">
                                            <h2 className="text-3xl font-black text-white mb-2">Account Information</h2>
                                            <p className="text-white/60">Tell us about your business</p>
                                        </div>

                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="md:col-span-2">
                                                <label className="block text-white/90 font-semibold mb-3">Account Name *</label>
                                                <input
                                                    type="text"
                                                    name="business_name"
                                                    value={formData.business_name}
                                                    onChange={handleChange}
                                                    className="w-full bg-dark-700/50 border border-white/10 rounded-xl px-5 py-4 text-white placeholder-white/30 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 transition-all"
                                                    placeholder="ABC Auto Parts & Salvage"
                                                />
                                            </div>

                                            <div className="md:col-span-2">
                                                <label className="block text-white/90 font-semibold mb-3">Contact Name *</label>
                                                <input
                                                    type="text"
                                                    name="contact_name"
                                            ...
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Account Website</label>
                                                <input
                                                    type="url"
                                                    name="website"
                                            ...
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Local Phone *</label>
                                                <input
                                                    type="tel"
                                                    name="phone"
                                            ...
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Toll Free</label>
                                                <input
                                                    type="tel"
                                                    name="toll_free"
                                            ...
                                            <div className="md:col-span-2">
                                                <label className="block text-white/90 font-semibold mb-3">Fax</label>
                                                <input
                                                    type="tel"
                                                    name="fax"
                                                    value={formData.fax}
                                ...
                                {step === 2 && (
                                    <div className="space-y-6 animate-fade-in">
                                        <div className="mb-8">
                                            <h2 className="text-3xl font-black text-white mb-2">Location Details</h2>
                                            <p className="text-white/60">Where can customers find you?</p>
                                        </div>

                                        <div className="space-y-6">
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Street Address *</label>
                                                <input
                                                    type="text"
                                                    name="address"
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                <div>
                                                    <label className="block text-white/90 font-semibold mb-3">ZIP/Postal Code *</label>
                                                    <input
                                                        type="text"
                                                        name="zip_code"
                                                ...
                                                <div>
                                                    <label className="block text-white/90 font-semibold mb-3">City *</label>
                                                    <input
                                                        type="text"
                                                        name="city"
                                                        value={formData.city}
                                                ...
                                                <div>
                                                    <label className="block text-white/90 font-semibold mb-3">State/Province *</label>
                                                    <input
                                                        type="text"
                                                        name="state"
                                                ...
                                                <div>
                                                    <label className="block text-white/90 font-semibold mb-3">Country</label>
                                                    <input
                                                        type="text"
                                                        name="country"
                                ...
                                {step === 3 && (
                                    <div className="space-y-6 animate-fade-in">
                                        <div className="mb-8">
                                            <h2 className="text-3xl font-black text-white mb-2">Business Owner</h2>
                                            <p className="text-white/60">Owner contact information</p>
                                        </div>

                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">First Name</label>
                                                <input
                                                    type="text"
                                            ...
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Last Name</label>
                                                <input
                                                    type="text"
                                            ...
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Owner Phone</label>
                                                <input
                                                    type="tel"
                                                    name="owner_phone"
                                            ...
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Owner Email</label>
                                                <input
                                                    type="email"
                                                    name="owner_email"
                                        ...
                                        {/* Payment Methods */}
                                        <div className="mt-8">
                                            <label className="block text-white/90 font-semibold mb-4">Payment Methods</label>
                                        ...
                                        {/* Business Hours */}
                                        <div className="mt-8">
                                            <label className="block text-white/90 font-semibold mb-4">Business Hours</label>
                                                ...
                                                {Object.keys(formData.business_hours).map(day => (
                                                    <div key={day} className="bg-dark-700/30 rounded-xl p-4">
                                                        <div className="flex items-center justify-between mb-3">
                                                            ...
                                                            <button
                                                                type="button"
                                                                onClick={() => addHourSlot(day)}
                                                                className="text-cyan-400 text-sm hover:text-cyan-300"
                                                            >
                                                                + Add Hours
                                                            </button>
                                                        </div>
                                                        {formData.business_hours[day].length === 0 ? (
                                                            <p className="text-white/40 text-sm">Closed</p>
                                                        ) : (
                                                            formData.business_hours[day].map((slot, idx) => (
                                                                <div key={idx} className="flex items-center gap-3 mb-2">
                                                                    <input
                                                                        type="time"
                                                                        value={slot.open}
                                                                        onChange={(e) => handleHoursChange(day, idx, 'open', e.target.value)}
                                                                        className="bg-dark-700 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                                    />
                                                                    <span className="text-white/60">to</span>
                                                                    <input
                                                                        type="time"
                                                                        value={slot.close}
                                                                        onChange={(e) => handleHoursChange(day, idx, 'close', e.target.value)}
                                                                        className="bg-dark-700 border border-white/10 rounded-lg px-3 py-2 text-white text-sm"
                                                                    />
                                                                    {formData.business_hours[day].length > 1 && (
                                                                        <button
                                                                            type="button"
                                                                            onClick={() => removeHourSlot(day, idx)}
                                ...
                                {step === 4 && (
                                    <div className="space-y-6 animate-fade-in">
                                        <div className="mb-8">
                                            ...
                                            <p className="text-white/60">What makes your yard special?</p>
                                        </div>

                                        <div className="space-y-6">
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Services Offered *</label>
                                                <textarea
                                                    name="services"
                                                    value={formData.services}
                                                    onChange={handleChange}
                                                    rows={3}
                                                    className="w-full bg-dark-700/50 border border-white/10 rounded-xl px-5 py-4 text-white placeholder-white/30 focus:border-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/20 transition-all resize-none"
                                                    placeholder="Auto parts, Towing, Recycling, etc."
                                                />
                                            </div>

                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Vehicle Makes/Brands *</label>
                                                <textarea
                                                    name="brands"
                                            ...
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Parts Categories</label>
                                                <textarea
                                            ...
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Business Description *</label>
                                                <textarea
                                                    name="description"
                                                ...
                                                <div className="flex items-center justify-between mt-2">
                                                    <p className={`text-sm ${formData.description.length >= 50 ? 'text-green-400' : 'text-white/40'}`}>
                                ...
                                {step === 5 && (
                                    <div className="space-y-6 animate-fade-in">
                                        <div className="mb-8">
                                            ...
                                            <p className="text-white/60">Select the advertising template that fits your needs</p>
                                        </div>
                                            ...
                                            {subscriptionPlans.map(plan => (
                                                ...
                                                >
                                                    {formData.subscription_plan === plan.id && (
                                                        <div className="absolute -top-3 -right-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full p-2">
                                ...
                                {step === 6 && (
                                    <div className="space-y-6 animate-fade-in">
                                        <div className="mb-8">
                                            <h2 className="text-3xl font-black text-white mb-2">Media & Images</h2>
                                            <p className="text-white/60">Make your listing stand out (optional)</p>
                                        </div>

                                        <div className="space-y-6">
                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Business Logo</label>
                                                <div className="relative">
                                                    <input
                                                        type="file"
                                                        name="logo"
                                                        ...
                                                        className="w-full bg-dark-700/50 border-2 border-dashed border-white/10 rounded-xl px-5 py-8 text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-cyan-500 file:text-white file:font-semibold hover:file:bg-cyan-600 cursor-pointer focus:border-cyan-500 focus:outline-none transition-all"
                                                    />
                                                    <p className="text-white/40 text-sm mt-2">Max 2MB, JPG or PNG</p>
                                                </div>
                                            </div>

                                            <div>
                                                <label className="block text-white/90 font-semibold mb-3">Yard Images</label>
                                                <div className="relative">
                                                    <input
                                                        type="file"
                                                        name="images"
                                                    ...
                                                    />
                                                    <p className="text-white/40 text-sm mt-2">Max 5 images, 5MB each</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between mt-12 pt-8 border-t border-white/10">
                                    {step > 1 ? (
                                        <button
                                            type="button"
                                            onClick={prevStep}
                                            className="group flex items-center gap-2 px-6 py-3 bg-dark-700/50 border border-white/10 text-white font-bold rounded-xl hover:bg-dark-600 transition-all duration-300"
                                        >
                                    ...
                                    {step < 6 ? (
                                        <button
                                            type="button"
                                            onClick={nextStep}
                                            className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-bold rounded-xl overflow-hidden transition-all duration-300 hover:scale-105 shadow-lg shadow-cyan-500/30"
                                        >
                                            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-700"></div>

            ...
            <div className="relative compact-section overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="compact-heading text-gray-400 leading-relaxed px-2">
                    ...
                    <div className="grid lg:grid-cols-2 compact-gap">
                        ...
                        <div className="space-y-3 sm:space-y-4 md:space-y-6">
                            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl compact-card hover:bg-white/10 transition-colors duration-300">
                                <h3 className="compact-title font-bold mb-3 sm:mb-4 md:mb-6 flex items-center gap-2 sm:gap-3">
                                    <span className="p-1.5 sm:p-2 md:p-3 bg-blue-500/20 rounded-lg md:rounded-xl text-blue-400">
                                ...
                                <div className="space-y-2 sm:space-y-3 md:space-y-4 text-gray-300">
                                    <p className="flex items-start gap-2 sm:gap-3 md:gap-4 compact-text">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-500 mt-0.5 sm:mt-1 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl compact-card hover:bg-white/10 transition-colors duration-300">
                                <h3 className="compact-title font-bold mb-3 sm:mb-4 md:mb-6 flex items-center gap-2 sm:gap-3">
                                    <span className="p-1.5 sm:p-2 md:p-3 bg-green-500/20 rounded-lg md:rounded-xl text-green-400">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div className="space-y-2 sm:space-y-3 md:space-y-4 text-gray-300">
                                    <a href="mailto:support@jynm.com" className="flex items-center gap-2 sm:gap-3 md:gap-4 hover:text-white transition-colors compact-text">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
                                        support@jynm.com
                                    </a>
                                    <a href="tel:+18005551234" className="flex items-center gap-2 sm:gap-3 md:gap-4 hover:text-white transition-colors compact-text">
                                        <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-gray-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        {/* Contact Form */}
                        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl compact-card relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-purple-500/5 pointer-events-none"></div>
                            <h2 className="compact-title font-bold mb-3 sm:mb-4 md:mb-6">Send us a Message</h2>
                            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 md:space-y-6 relative">

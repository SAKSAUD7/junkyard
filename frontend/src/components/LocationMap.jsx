...
const LocationMap = ({ address, city, state, zipcode, name }) => {
    ...
    return (
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl overflow-hidden">
            <div className="compact-card border-b border-white/10">
                <h2 className="compact-title font-bold text-white flex items-center gap-1.5 sm:gap-2">
                ...
                <p className="text-white/60 compact-text mt-1 sm:mt-2">{fullAddress}</p>
            </div>
            ...
            <div className="p-2 sm:p-3 md:p-4 bg-white/5">
                <a
                    ...
                    className="inline-flex items-center gap-1.5 sm:gap-2 text-cyan-400 hover:text-cyan-300 font-semibold transition-colors compact-text"
                >

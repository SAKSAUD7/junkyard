            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 compact-gap">
                    {trustedVendors.map((vendor) => (
                        ...
                        >
                            {/* Card - Compact */}
                            <div className="relative bg-dark-800/40 backdrop-blur-sm border border-white/10 rounded-lg md:rounded-xl compact-card transform transition-all duration-300 hover:border-cyan-400/50">
                                {/* Trusted Badge - Smaller on mobile */}
                                <div className="absolute -top-1.5 -right-1.5 md:-top-2 md:-right-2 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full p-1 md:p-1.5">
                                ...
                                {/* Vendor Logo - Compact */}
                                <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 bg-gradient-to-br from-yellow-400/10 to-orange-500/10 rounded-md md:rounded-lg flex items-center justify-center mb-1.5 sm:mb-2 mx-auto group-hover:scale-105 transition-transform duration-300">
                                    {vendor.logo && vendor.logo !== '/images/logo-placeholder.png' ? (
                                        ...
                                        <svg className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-yellow-400" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                {/* Vendor Name - Compact */}
                                <h3 className="text-xs sm:text-sm md:text-base font-bold text-white mb-1 group-hover:text-cyan-400 transition-colors line-clamp-2 text-center min-h-[2rem] sm:min-h-[2.5rem]">
                                    {vendor.name}
                                </h3>

                                {/* Location - Compact */}
                                <div className="flex items-center justify-center gap-1 text-white/50 mb-1.5 sm:mb-2">
                                ...
                                <div className="flex items-center justify-center gap-1 mb-1.5 sm:mb-2">
                                    ...
                                    <span className="text-[10px] sm:text-xs text-white/60">{vendor.rating}</span>
                                </div>

                                {/* CTA - Compact */}
                                <div className="flex items-center justify-center pt-1.5 sm:pt-2 border-t border-white/10">
                                    <span className="text-[10px] sm:text-xs text-white/60 group-hover:text-cyan-400 transition-colors">View Details</span>
                                    <svg className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-cyan-400 group-hover:translate-x-0.5 transition-transform ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">

    ...
    return (
        <section className="tv-section">
            ...
            <div className="tv-orbital-wrapper">
                ...
                {/* ── DESKTOP: absolute orbital cards ─────── */}
                <div className="tv-orbital-cards">
                    {vendors.slice(0, 6).map((vendor, i) => (
                        <div key={vendor.id} className={`tv-orbit-slot tv-orbit-${i}`}>
                            <CircleCard vendor={vendor} />
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="tv-grid-fallback">
                {vendors.slice(0, 6).map(vendor => (
                    <CircleCard key={vendor.id} vendor={vendor} />
                ))}
            </div>
        </section>
    );

            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                    {trustedVendors.map((vendor) => (
                        ...
                        >
                            {/* Card */}
                            <div className="relative bg-dark-800/40 backdrop-blur-sm border border-white/10 rounded-xl p-3 transform transition-all duration-300 hover:border-cyan-400/50">
                                {/* Trusted Badge - Smaller */}
                                ...
                                {/* Vendor Logo - Smaller */}
                                <div className="w-12 h-12 bg-gradient-to-br from-yellow-400/10 to-orange-500/10 rounded-lg flex items-center justify-center mb-2 mx-auto group-hover:scale-105 transition-transform duration-300">
                                    {vendor.logo && vendor.logo !== '/images/logo-placeholder.png' ? (
                                        <img src={vendor.logo} alt={vendor.name} className="w-10 h-10 object-contain" />
                                    ) : (
                                ...
                                {/* Vendor Name - Smaller */}
                                <h3 className="text-sm font-bold text-white mb-1 group-hover:text-cyan-400 transition-colors line-clamp-2 text-center min-h-[2.5rem]">
                                    {vendor.name}
                                </h3>
                                ...
                                <div className="flex items-center justify-center gap-1 mb-2">
                                    ...
                                    <span className="text-xs text-white/60">{vendor.rating}</span>
                                </div>

                                {/* CTA - Smaller */}
                                <div className="flex items-center justify-center pt-2 border-t border-white/10">
                                    <span className="text-xs text-white/60 group-hover:text-cyan-400 transition-colors">View Details</span>
                                    <svg className="w-3 h-3 text-cyan-400 group-hover:translate-x-0.5 transition-transform ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">

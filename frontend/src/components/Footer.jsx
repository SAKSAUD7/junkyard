        ...
        <footer className="relative bg-dark-950 border-t border-white/5 font-sans">
            <div className="relative max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 md:py-16">
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-12 mb-6 md:mb-12">
                    ...
                    <div className="col-span-2 md:col-span-1">
                        <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-6">
                            <div className="relative">
                                ...
                                <div className="relative bg-dark-900 border border-white/10 rounded-lg p-1.5 md:p-2">
                            ...
                            <div className="flex flex-col">
                                <span className="text-base md:text-xl font-black text-white leading-none tracking-tighter font-display">JYNM</span>
                                <span className="text-[8px] md:text-[10px] uppercase tracking-widest text-white/40 font-mono">Industrial Parts</span>
                            </div>
                        </div>
                        <p className="text-white/50 text-xs md:text-sm mb-3 md:mb-6 leading-relaxed">
                        ...
                        <div className="flex gap-1.5 md:gap-2">
                            {[
                                ...
                                >
                                    ...
                                    <div className="relative bg-white/5 hover:bg-white/10 border border-white/5 hover:border-primary-500/30 p-1.5 md:p-2.5 rounded-lg transition-all">
                                        <div className="text-white/40 group-hover:text-primary-400 transition-colors">
                    ...
                    {/* Quick Links */}
                    <div>
                        <h3 className="font-bold text-xs md:text-sm uppercase tracking-wider text-white mb-3 md:mb-6 font-mono">Quick Links</h3>
                    ...
                    {/* Resources */}
                    <div>
                        <h3 className="font-bold text-xs md:text-sm uppercase tracking-wider text-white mb-3 md:mb-6 font-mono">Resources</h3>
                        <ul className="space-y-1.5 md:space-y-3 text-xs md:text-sm">
                            {[
                    ...
                    {/* Contact Info */}
                    <div className="col-span-2 md:col-span-1">
                        <h3 className="font-bold text-xs md:text-sm uppercase tracking-wider text-white mb-3 md:mb-6 font-mono">Contact</h3>
                        <div className="space-y-2 md:space-y-4 text-xs md:text-sm">
                            <a href="tel:1-866-293-3731" className="flex items-center gap-2 md:gap-3 text-white/50 hover:text-primary-400 transition-colors group">
                                <div className="bg-white/5 p-1.5 md:p-2 rounded-lg border border-white/5 group-hover:border-primary-500/30 transition-colors">
                            ...
                            <a href="mailto:info@jynm.com" className="flex items-center gap-2 md:gap-3 text-white/50 hover:text-primary-400 transition-colors group">
                                <div className="bg-white/5 p-1.5 md:p-2 rounded-lg border border-white/5 group-hover:border-primary-500/30 transition-colors">
                                    <svg className="w-3 h-3 md:w-4 md:h-4" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="flex items-start gap-2 md:gap-3 text-white/50 mt-3 md:mt-6 pt-3 md:pt-6 border-t border-white/5">
                                <div className="bg-white/5 p-1.5 md:p-2 rounded-lg border border-white/5">
                                    <svg className="w-3 h-3 md:w-4 md:h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                                    </svg>
                                </div>
                                <span className="text-xs md:text-sm">Nationwide Service<br /><span className="text-[10px] md:text-xs opacity-60">Serving all 50 US States</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* Bottom Bar */}
                <div className="border-t border-white/5 pt-4 md:pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-2 md:gap-4 text-[10px] md:text-xs text-white/30 uppercase tracking-wider font-mono">

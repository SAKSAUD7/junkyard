                    ...
                    {navLinks.map((link) => (
                        ...
                        >
                            <span className="w-5 flex justify-center text-slate-400">
                                ...
                                {link.path === '/vendors' && <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 2a4 4 0 00-4 4v1H5a1 1 0 00-.994.89l-1 9A1 1 0 004 18h12a1 1 0 00.994-1.11l-1-9A1 1 0 0015 7h-1V6a4 4 0 00-4-4zm2 5V6a2 2 0 10-4 0v1h4zm-6 3a1 1 0 112 0 1 1 0 01-2 0zm7-1a1 1 0 100 2 1 1 0 000-2z" clipRule="evenodd" /></svg>}
                                {link.path === '/browse' && <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd" /></svg>}
                                ...
                                {(!['/', '/vendors', '/browse', '/blog', '/about', '/contact'].includes(link.path)) && <div className="w-1.5 h-1.5 rounded-full bg-slate-300"></div>}
                            </span>
                            {link.label}
                        </Link>
                    ))}

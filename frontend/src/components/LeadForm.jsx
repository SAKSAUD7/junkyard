    ...
    return (
        <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="bg-white/95 backdrop-blur-xl p-8 rounded-b-3xl shadow-2xl border-x-2 border-b-2 border-white/20">
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-cyan-500 to-purple-500 animate-gradient"></div>
                    <div className="relative bg-gradient-to-r from-blue-500 to-cyan-500 group-hover:from-blue-600 group-hover:to-cyan-600 text-white font-black py-4 px-6 rounded-xl text-lg transition-all duration-300 shadow-glow group-hover:shadow-glow-lg transform group-hover:scale-[1.02]">
                        GET MY QUOTE NOW →
                    </div>
                </button>

...
export default function VendorBadges({ isTopRated, isFeatured }) {
    ...
    return (
        <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-2">
            {isTopRated && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 sm:px-2.5 sm:py-1 bg-gradient-to-r from-yellow-500 to-orange-500 text-white text-[10px] sm:text-xs font-bold rounded-full shadow-lg">

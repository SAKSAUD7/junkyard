                ...
                <div className="flex justify-between items-center h-20">
                    ...
                    <Link to="/" className="flex items-center gap-3 group">
                        <div className="relative">
                            ...
                            <div className="relative bg-dark-900 border border-white/10 rounded-lg p-2 group-hover:border-primary-500/50 transition-colors">
                        ...
                        <div className="flex flex-col">
                            <span className="text-xl font-black tracking-tighter text-white leading-none font-display">
                                JYNM
                            </span>
                    ...
                    <div className="hidden md:block">
                        ...
                        >
                            <div className="absolute inset-0 bg-primary-600 blur opacity-20 group-hover:opacity-40 transition-opacity"></div>
                            <div className="relative bg-primary-600 hover:bg-primary-500 text-white font-bold text-sm uppercase tracking-wider px-6 py-2.5 rounded-lg transition-all duration-200 border border-primary-500 shadow-lg shadow-primary-900/20 font-mono">
                                Get Quote
                            </div>
                        </Link>
                    </div>
                    ...
                    {/* Mobile Menu Button */}
                    <button
                        className="md:hidden p-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 text-white transition-colors"
                    ...
                    <div className="px-4 py-6 space-y-2">
                        {navLinks.map(link => (
                            <Link
                                key={link.path}
                                to={link.path}
                                className={`block px-5 py-3 rounded-lg font-mono text-sm uppercase font-bold transition-all duration-300 ${isActive(link.path)
